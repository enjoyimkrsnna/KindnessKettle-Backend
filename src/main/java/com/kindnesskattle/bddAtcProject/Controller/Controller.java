...
public class Controller {
    ...
    public ResponseEntity<String> home() {
        ...
        return ResponseEntity.ok("<html><body style='background-color: #f4f4f4; color: #333; font-family: Arial, sans-serif; text-align: center;'>" +
                ...
                "</ul>" +
                "<p style='font-size: 18px;'>We're here to make your experience delightful. Feel free to explore and share kindness with our community. If you have any questions, reach out to us. Cheers to a journey filled with positivity and warmth! Let's Rock now 🚀.Best of luck</p>" +
                "</body></html>");
